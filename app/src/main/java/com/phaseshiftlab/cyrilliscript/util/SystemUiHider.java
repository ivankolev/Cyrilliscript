package com.phaseshiftlab.cyrilliscript.util;
...
abstract class SystemUiHider {
     ...
     */
    static SystemUiHider getInstance(Activity activity, View anchorView, int flags) {
    ...
    SystemUiHider(Activity activity, View anchorView, int flags) {
        mActivity = activity;
